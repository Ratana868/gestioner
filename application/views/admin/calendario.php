...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
          ...
          <span class="logo-mini">  <img src="<?php echo base_url() .'assets/images/transp.png'?>" class="img-responsive logo-bagsa"><b>GESTION</b>ER</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>GESTION</b>ER</span>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <!-- Control Sidebar Toggle Button -->
              <li>
                <a href="<?= base_url(); ?>admin/login/logout_ci"><i class="fa fa-sign-out"></i></a>
              </li>
        </ul>
      </div>
    </nav>
...
<script>
  $(function () {
    ...
    /* initialize the calendar  AIzaSyD_VY5w4cMwxlmMkKCZ7mB8WccP7m9bMz0 
     -----------------------------------------------------------------*/
    //Date for the calendar events (dummy data)  lealp88@gmail.com
    var date = new Date();
    var d = date.getDate(),
        m = date.getMonth(),
        y = date.getFullYear();
...
$(document).ready(function() {
    $('#cal').fullCalendar({
        googleCalendarApiKey: 'AIzaSyD_VY5w4cMwxlmMkKCZ7mB8WccP7m9bMz0 ',
        events: {
            googleCalendarId: 'lealp88@gmail.com',
