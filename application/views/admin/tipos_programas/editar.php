			...
			<div class="col-xs-12">
				<div class="box box-primary">
		          <div class="box-header with-border">
		            <h3 class="box-title">Editar Tipo de Programa de seguridad</h3>
		          </div><!-- /.box-header -->
		          ...
		          <?
		           ...
		           ?>
		          <!-- form start -->
		          <?=form_open(base_url().'admin/tipos_programas/editar/'. $id_tipo,$form)?>
		            ...
		            <div class="box-body">
		              ...
		              <div class="form-group <?= form_error('tipo') ? 'has-error' : ''?>">
		                ...
		                <div class="col-sm-10">
		                  <input type="text" name="tipo" class="form-control" placeholder="Tipo" value="<?= set_value('tipo',$tipo) ?>">
		                </div>
		              </div>
		              <div class="form-group <?= form_error('descripcion') ? 'has-error' : ''?>">
		                <label for="tipo" class="col-sm-2 control-label">Descripcion</label>
		                <div class="col-sm-10">
		                	<textarea name="descripcion" placeholder="Descripcion" rows="3" class="form-control" value="<?= set_value('descripcion',$descripcion) ?>"><?= set_value('descripcion',$descripcion) ?></textarea>
		                </div>
		              </div>
